...
?>
<style>
.ctf-stage-header { background: linear-gradient(135deg, #1a0a1f 0%, #0f0a2a 100%); border-radius: 14px; padding: 25px 30px; color: #fff; margin-bottom: 25px; border: 1px solid rgba(168,85,247,0.3); }
...
<div class="main-content"><div class="main-content-inner"><div class="page-content">
    ...
    <div class="ctf-stage-header">
        ...
        <div style="display: flex; gap: 10px; margin-top: 14px; flex-wrap: wrap;">
            <span style="background: rgba(255,255,255,0.08); padding: 4px 12px; border-radius: 8px; font-size: 12px; color: #e2e8f0;">🔧 技术：计划任务 · 注册表 Run 键 · 服务 · WMI 事件订阅</span>
            <span style="background: rgba(255,255,255,0.08); padding: 4px 12px; border-radius: 8px; font-size: 12px; color: #e2e8f0;"><a href="osep_hub.php" style="color: #d8b4fe;">← 返回 OSEP 大厅</a></span>
        </div>
    </div>
