...
$flags_db = [
    ...
    'flag8' => ['flag' => 'flag{OSEP_L8_Win32API_WOW64_Registry_Arch}', 'name' => 'L8: Win32 API · WOW64 · 架构基础', 'points' => 150, 'file' => 'osep_l8_win_api.php', 'difficulty' => '初级'],
    'flag9' => ['flag' => 'flag{OSEP_L9_Office_Macro_VBA_InMemory_Shell}', 'name' => 'L9: Office 宏武器化 · VBA 免杀', 'points' => 200, 'file' => 'osep_l9_office_macro.php', 'difficulty' => '中级'],
    'flag10' => ['flag' => 'flag{OSEP_L10_DLL_Reflect_ProcessHollow_Inject}', 'name' => 'L10: 进程注入与进程镂空', 'points' => 250, 'file' => 'osep_l10_process_inject.php', 'difficulty' => '中级'],
    'flag11' => ['flag' => 'flag{OSEP_L11_AMSI_UAC_Bypass_PowerShell}', 'name' => 'L11: AMSI · UAC 绕过研究', 'points' => 300, 'file' => 'osep_l11_amsi_bypass.php', 'difficulty' => '高级'],
    'flag12' => ['flag' => 'flag{OSEP_L12_AppLocker_Bypass_LOLBIN_Trusted}', 'name' => 'L12: AppLocker 应用白名单绕过', 'points' => 250, 'file' => 'osep_l12_applocker.php', 'difficulty' => '中级'],
    'flag13' => ['flag' => 'flag{OSEP_L13_DNS_Tunnel_DomainFront_Network_Bypass}', 'name' => 'L13: 网络过滤 · DNS隧道 · 域前置', 'points' => 300, 'file' => 'osep_l13_net_evasion.php', 'difficulty' => '高级'],
    'flag14' => ['flag' => 'flag{OSEP_L14_Token_Kerberos_Cred_Harvest}', 'name' => 'L14: 凭据攻击 · Access Token 操纵', 'points' => 350, 'file' => 'osep_l14_cred_attack.php', 'difficulty' => '专家'],
    'flag15' => ['flag' => 'flag{OSEP_L15_MSSQL_LinkedServer_xp_cmdshell_AD}', 'name' => 'L15: MSSQL 深度利用 · 链接服务器', 'points' => 350, 'file' => 'osep_l15_mssql.php', 'difficulty' => '专家'],
    'flag16' => ['flag' => 'flag{OSEP_L16_Kiosk_Enum_Escape_PrivEsc}', 'name' => 'L16: Kiosk 逃逸技术研究', 'points' => 250, 'file' => 'osep_l16_kiosk_escape.php', 'difficulty' => '高级'],
    'flag17' => ['flag' => 'flag{OSEP_L17_Linux_PostEx_SharedLib_DevOps_Kerberos}', 'name' => 'L17: Linux 后渗透·共享库劫持·DevOps•Kerberos', 'points' => 300, 'file' => 'osep_l17_linux_postex.php', 'difficulty' => '专家'],
    'flag18' => ['flag' => 'flag{OSEP_L18_AD_ACL_Kerberos_Delegation_Forest_Trust}', 'name' => 'L18: AD 深度利用：ACL·Kerberos委派·跨林 [终章]', 'points' => 400, 'file' => 'osep_l18_ad_deep.php', 'difficulty' => '专家'],
];
        ...
        <div class="page-content">
            ...
            <div class="osep-hero-banner">
                <h1 class="osep-title">
                    ...
                    <span class="osep-badge">18 大关卡 · 4750 PTS</span>
