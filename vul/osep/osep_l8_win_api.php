...
<div class="ctf-stage-header">
  ...
  <p style="color: var(--text-secondary);font-size:14px;margin:0;line-height:1.6;">深入理解 Windows 架构基础：x86/x64 内存模型、WOW64 子系统、Win32 API 调用链、Windows 注册表结构，以及 C# 和 PowerShell 与 Win32 API 交互的底层原理。</p>
