    ...
    <div class="main-content-inner">
        <div class="page-content">
            ...
            <div class="overview-hero-card">
                ...
                <p>在企业级微服务与多云办公生态中，单点登录（Single Sign-On, SSO）已成为标配。SAML 2.0 (Security Assertion Markup Language) 是一种基于 XML 的开放标准，被广泛应用于企业 IdP（身份提供商，如 Okta、Azure AD）与 SP（服务提供商，即目标应用）之间的跨域身份联邦认证。</p>
            </div>
