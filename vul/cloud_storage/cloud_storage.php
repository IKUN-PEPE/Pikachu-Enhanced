    ...
    <div class="main-content-inner">
        <div class="page-content">
            ...
            <div class="overview-hero-card">
                <h1>
                    Cloud_Storage Overview
                    <span class="overview-badge">专项演练</span>
                </h1>
                <p>随着云原生架构与前后端分离的发展，海量静态资源（如视频、图片、用户上传的附件、前端前端代码、甚至是数据库备份日志）不再存储于传统 Web 服务器本地，而是全部托管在各大公有云厂商提供的对象存储服务（Object Storage Service / S3 Bucket）中。</p>
            </div>
