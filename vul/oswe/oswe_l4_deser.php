...
<div class="main-content"><div class="main-content-inner"><div class="page-content">
    <div class="ctf-stage-header">
        ...
        <p style="color: var(--text-secondary); font-size: 14px; margin: 0; line-height: 1.6;">研究 PHP 反序列化漏洞原理：魔术方法调用链（POP Chain）、Gadget 类识别，以及 Java ysoserial CommonsCollections 利用链的理论基础。</p>
        <div style="display: flex; gap: 10px; margin-top: 14px; flex-wrap: wrap;">
            <span style="background: var(--bg-secondary); padding: 4px 12px; border-radius: 8px; font-size: 12px; color: var(--text-secondary); border: 1px solid var(--border-color);">🔧 机制：__wakeup · __destruct · POP Chain · ysoserial · Gadget Class</span>
