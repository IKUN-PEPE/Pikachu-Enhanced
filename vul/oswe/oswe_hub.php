<?php
/**
 * OSWE CTF Hub - Advanced Web Attacks (7 Stages, 1500 PTS)
 * OSCE³ - OSWE Direction
 */
        ...
        <div class="page-content">
            ...
            <div class="oswe-hero-banner">
                <h1 class="oswe-title">
                    ...
                    <span class="oswe-badge">7 大关卡 · 1500 PTS</span>
                ...
                <div style="display: flex; gap: 15px; flex-wrap: wrap;">
                    ...
                    <div class="stat-pill"><i class="fa fa-trophy" style="color: #fbbf24;"></i> 当前积分：<strong><?php echo $total_score; ?> / 1500</strong> PTS</div>
