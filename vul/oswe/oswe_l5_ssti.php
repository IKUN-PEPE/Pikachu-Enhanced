...
?>
<style>
.ctf-stage-header { background: linear-gradient(135deg, #060c18 0%, #0c1818 100%); border-radius: 14px; padding: 25px 30px; color: #fff; margin-bottom: 25px; border: 1px solid rgba(99,102,241,0.3); }
...
<div class="main-content"><div class="main-content-inner"><div class="page-content">
    <div class="ctf-stage-header">
        ...
        <p style="color: #a5b4fc; font-size: 14px; margin: 0; line-height: 1.6;">分析 SSTI 服务端模板注入漏洞：识别不同模板引擎（Jinja2/Twig/Smarty），从 {{7*7}} 探测，到通过 Python 类继承链访问 os 模块执行命令。</p>
        <div style="display: flex; gap: 10px; margin-top: 14px; flex-wrap: wrap;">
            <span style="background: rgba(255,255,255,0.08); padding: 4px 12px; border-radius: 8px; font-size: 12px; color: #e2e8f0;">🔧 引擎：Jinja2 · Twig · Smarty · Mako · Velocity · FreeMarker</span>
