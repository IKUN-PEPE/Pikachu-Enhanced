...
?>
<style>
.ctf-stage-header { background: linear-gradient(135deg, #0c1218 0%, #1e1208 100%); border-radius: 14px; padding: 25px 30px; color: #fff; margin-bottom: 25px; border: 1px solid rgba(99,102,241,0.3); }
...
<div class="main-content"><div class="main-content-inner"><div class="page-content">
    <div class="ctf-stage-header">
        ...
        <p style="color: #a5b4fc; font-size: 14px; margin: 0; line-height: 1.6;">深入 SQL 注入的完整利用链：从认证绕过，到 UNION SELECT 提取敏感数据，再到 INTO OUTFILE 写 Webshell，理解 SQLi 如何贯穿整个攻击链。</p>
        <div style="display: flex; gap: 10px; margin-top: 14px; flex-wrap: wrap;">
            <span style="background: rgba(255,255,255,0.08); padding: 4px 12px; border-radius: 8px; font-size: 12px; color: #e2e8f0;">🔧 工具：sqlmap · 手工注入 · INTO OUTFILE · Prepared Statement</span>
