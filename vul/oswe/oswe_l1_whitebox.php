...
?>
<style>
.ctf-stage-header { background: linear-gradient(135deg, #0c1218 0%, #0f1e30 100%); border-radius: 14px; padding: 25px 30px; color: #fff; margin-bottom: 25px; border: 1px solid rgba(99,102,241,0.3); }
...
<div class="main-content"><div class="main-content-inner"><div class="page-content">
    <div class="ctf-stage-header">
        ...
        <p style="color: #a5b4fc; font-size: 14px; margin: 0; line-height: 1.6;">学习白盒代码审计的系统方法论：污点分析（Taint Analysis）、危险函数定位、数据流追踪，以及 Semgrep/CodeQL 自动化工具的使用。</p>
        <div style="display: flex; gap: 10px; margin-top: 14px; flex-wrap: wrap;">
            <span style="background: rgba(255,255,255,0.08); padding: 4px 12px; border-radius: 8px; font-size: 12px; color: #e2e8f0;">🔧 工具：Semgrep · CodeQL · grep · PHP/Python/Java 审计要点</span>
