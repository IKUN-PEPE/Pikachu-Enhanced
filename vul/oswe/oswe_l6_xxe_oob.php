...
?>
<style>
.ctf-stage-header{background:linear-gradient(135deg,#060c18 0%,#180c06 100%);border-radius:14px;padding:25px 30px;color:#fff;margin-bottom:25px;border:1px solid rgba(99,102,241,0.3);}
...
<div class="main-content"><div class="main-content-inner"><div class="page-content">
    <div class="ctf-stage-header">
        ...
        <p style="color:#a5b4fc;font-size:14px;margin:0;line-height:1.6;">深入 XXE 外部实体注入攻击链：带外数据提取（OOB XXE）、通过 Error 消息提取数据的 Blind XXE、XXE to SSRF 的组合利用，以及外部 DTD 托管技术。</p>
        <div style="display:flex;gap:10px;margin-top:14px;flex-wrap:wrap;">
            <span style="background:rgba(255,255,255,0.08);padding:4px 12px;border-radius:8px;font-size:12px;color:#e2e8f0;">🔧 技术：XXE · OOB · Blind XXE · SSRF · 外部 DTD · FTP/HTTP 回调</span>
